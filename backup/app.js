...
var code = fs.readFileSync("./public/js/Voting.sol").toString();
  ...
  function(e, contract) {
    if (!e) {
      if (!contract.address) {
        ...
        console.log("Votes for Zoro before: ");
        //totalVotesFor() is a function in our contract
        console.log(contractInstance.totalVotesFor.call("Zoro").valueOf());
        ...
        console.log(
          contractInstance.voteForCandidate("Zoro", {
            from: web3.eth.accounts[0]
          })
        );

        //votes for Zoro should go up by 1
        console.log("Votes for Zoro after: ");
        console.log(contractInstance.totalVotesFor.call("Zoro").valueOf());
        //write the contract address and abi to file for client side JS to use to interact with contract
        fs.writeFile(
          "./public/js/contract.json",
          JSON.stringify(
            {
